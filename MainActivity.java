package com.example.covertwebtopdf;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button savePdfBtn, backPdfBtn;
        // Initializing the Button
        savePdfBtn = (Button)findViewById(R.id.savePdfBtn);
        backPdfBtn =(Button)findViewById(R.id.backPdfBtn);
        ...
        backPdfBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void requestCameraPermission() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ...
            // You can proceed with using the camera in WebView
        }
